...
class TestMethods(unittest.TestCase):
    ...
    def test_all(self):
        ...
        #                  ['clf', 'gray', 'colorbar', 'xlabel', 'ylabel', 'title', 'savefig', 'boxplot', 'pie', 'axis',
        #                   'plot', 'legend', 'scatter', 'gca', 'clabel', 'contour']] + ['mpl_toolkits.mplot3d.Axes3D',
        #                   'scipy.misc.imread', 'numpy.arange', 'numpy.linspace', 'sklearn.datasets.load_iris']
