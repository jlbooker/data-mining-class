...
class TestMethods(unittest.TestCase):
    ...
    def make_statistics_tests(self):
        ...
        for name, rng in [('median', randi), ('nanmean', nanrandi)]:
            path_correct = 'numpy.%s' % name
            test = {
                'unlock': [path_correct],
                'import': ['math'],
        ...
        for name, rng in [('percentile', randi)]:
            path_correct = 'numpy.%s' % name
            test = {
                'unlock': [path_correct],
                'import': ['math'],
    ...
    def test_all(self):
        ...
        # self.check_data_processing(['pandas', 'numpy', 'string'])
        # unlocked_imports += self.check_against_standard(unlocked_imports, self.make_distance_tests())
        # self.check_self_similarity(['spotipy', 'json', 'matplotlib.pyplot', 'numpy.exp', 'os'] + unlocked_imports)
